...
namespace Test.UnitTests.TestDataLayer
{
    public class Ch07_ValueConverters
    {
        ...
        public void TestValueConvertersSqlServerOk()
        {
            ...
            var options = SqliteInMemory.CreateOptionsWithLogTo<Chapter07DbContext>(
        ...
        public void TestValueConvertersCurrentValuesOk()
        {
            ...
            entry.Property(nameof(ValueConversionExample.EnumFlags)).CurrentValue
                .ShouldEqual(FlagEnum.Flag1 | FlagEnum.Flag3);
        }
