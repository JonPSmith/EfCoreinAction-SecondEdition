    ...
    public class Ch11_AddAlterOneToOne
    {
        ...
        public void TestAddNotTrackedOneTrackedOk()
        {
            ...
            ex.InnerException.Message.ShouldEqual(
                "SQLite Error 19: 'UNIQUE constraint failed: OneOptionalEntities.Id'.");
        }
        ...
        public void TestChangeTrackerAddNotifyOk()
        {
            ...
            //VERIFY
            var checkEntity = context.Notify.Include(x => x.OneToOne).First();

            checkEntity.OneToOne.ShouldNotBeNull();
        }
        ...
        public void TestChangeTrackerUpdateNotifyOk()
        {
            ...
            //VERIFY
            var checkEntity = context.Notify.Include(x => x.OneToOne).Single();
            checkEntity.OneToOne.ShouldNotBeNull();
        }
